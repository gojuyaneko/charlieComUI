<template>
  ...
  <div class="homepage">
    ...
    <!-- 光夜变奏 -->
    <div>
      <div class="pc-homepage-background2" id="pcBg2" >
    ...
    <!-- 背景2 -->
    <!-- 灵犀相册 -->
    <div class="pc-homepage-background2" id="pcBg3">
    ...
    <!-- 背景3 -->
    <!-- 记忆收藏 -->
    <div class="pc-homepage-background2" id="pcBg4">
      <div class="pc-menu">
        <myMenu></myMenu>
      </div>
