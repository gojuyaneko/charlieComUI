...
<div class="text-bg">
      ...
      <li class="reload" v-show="wineContentVisible && choiceshow && !buffer" @click="choiceshow=true;buffer=true;wineContentVisible=false;"></li>
      ...
      <li class="reload" v-if="waitContentVisible && choiceshow && !buffer1" @click="choiceshow=true;waitContentVisible=false;buffer1=true"></li>
      ...
      <li class="reload" v-show="truthContentVisible && choiceshow1 && !buffer" @click="choiceshow1=true;buffer=true;truthContentVisible=false;"></li>
      ...
      <li class="reload" v-if="yesContentVisible && choiceshow1 && !buffer1" @click="choiceshow1=true;yesContentVisible=false;buffer1=true"></li>
      ...
      <li class="reload" v-show="(topContentVisible || storeContentVisible) && choiceshow2 && !buffer"
