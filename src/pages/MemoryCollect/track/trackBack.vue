...
export default {
  ...
  data() {
    return {
      ...
      minorTitles: [
        {
          bg: require("../track/轨迹3/title1.png"),
          num:0,
        },
        {
          bg: require("../track/轨迹3/title2.png"),
          num:1,
        },
        {
          bg: require("../track/轨迹3/title3.png"),
          num:2,
        },
        {
          bg: require("../track/轨迹3/title4.png"),
          num:3,
        },
        {
          bg: require("../track/轨迹3/title5.png"),
          num:4,
        },
        {
          bg: require("../track/轨迹3/title6.png"),
          num:5,
        },
      ],
      minorDates: [
        {
          bg: require("../track/轨迹3/minor1.png"),
          num:0,
        },
        {
          bg: require("../track/轨迹3/minor2.png"),
          num:1,
        },
        {
          bg: require("../track/轨迹3/minor3.png"),
          num:2,
        },
        {
          bg: require("../track/轨迹3/minor4.png"),
          num:3,
        },
        {
          bg: require("../track/轨迹3/minor5.png"),
          num:4,
        },
        {
          bg: require("../track/轨迹3/minor6.png"),
          num:5,
        },
      ],
      contentDataList:[],
  ...
  methods: {
    ...
    getPara() {
      getTP({cardindex:2,sessionIndex:this.Index}).then((res) => {
        this.subContent=[]
...
.video-btn {
  background-image: url("./轨迹3/video.png");
  background-size: 100% 100%;
  cursor: pointer;
  position: absolute;
  top: -85px;
...
.btn1, .btn2, .btn3, .btn4, .btn5, .btn6 {
  background-image: url("./轨迹3/btn.png");
  background-size: 100% 100%;
  cursor: pointer;
  position: relative;
  height: 19px;
...
.active1, .active2, .active3, .active4, .active5, .active6 {
  background-image: url("./轨迹3/active.png");
  background-size: 100% 100%;
  position: relative;
  height: 15.2px;
  width: 8.8px;
